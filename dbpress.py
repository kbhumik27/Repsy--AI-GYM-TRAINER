...
# Function to check dumbbell press form
def check_db_press_form(shoulder, elbow, wrist):
...
# Main function for dumbbell press
def db_press():
    ...
    while True:
        ...
        try:
            ...
            form_feedback = check_db_press_form(shoulder, elbow, wrist)
...
def video_feed():
    return Response(db_press(), mimetype='multipart/x-mixed-replace; boundary=frame')
